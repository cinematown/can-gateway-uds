...
| 파일 | 역할 |
|---|---|
| `Core/Src/bcm_input.c` | DIP 스위치, 버튼 GPIO 입력 |
| `Core/Src/bcm_signal.c` | `protocol_ids.h` 매크로로 `0x470` 데이터 조립 |
| `Core/Src/bcm_can.c` | `common/can_bsp.c/h`를 통한 CAN 송수신 |
| `Core/Src/bcm_main.c` | FreeRTOS Task 연결 |
